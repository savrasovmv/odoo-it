...
class HrEmployee(models.Model):
    ...
    # Возраст
    age = fields.Integer(string="Возраст", compute="_compute_age", compute_sudo=True, groups="hr.group_hr_user")
    birthday_month = fields.Integer(string="Месяц рождения", compute="_compute_age", store=True, compute_sudo=True, groups="hr.group_hr_user")
    birthday_day = fields.Integer(string="День месяца рождения", compute="_compute_age", store=True, compute_sudo=True, groups="hr.group_hr_user")
    ...
    # AD
    ad_users_id = fields.Many2one("ad.users", string="Пользователь AD", groups="hr.group_hr_user")
    ...
    service_status = fields.Selection([
        ...
        ('fired', 'Уволен'),
    ], string='Статус', default='work', compute="_compute_status", groups="hr.group_hr_user")

    service_status_start_date = fields.Date(string='Начало', compute="_compute_status", groups="hr.group_hr_user")
    service_status_end_date = fields.Date(string='Окончание', compute="_compute_status", groups="hr.group_hr_user")
